	...
	<div class="am-cf admin-main">
		...
		<div class="nav-navicon admin-main admin-sidebar">
			...
			<div class="sideMenu">
				...
				<ul>
					<li><a href="studentcheck1">学生信息查询</a></li>
					<li><a href="studentupdatecheck1">学生信息修改</a></li>
				</ul>
				<h3 class="am-icon-flag">
					<em></em>系统设置
				</h3>
		...
		<div class="admin">
			...
			<div class="admin-biaoge">
				...
				<h1 align="center" style="font-family: '微软雅黑';font-size: 25px">欢迎使用本系统</h1>
				<pre align="center" style="font-family: '微软雅黑';font-size: 20px">本系统可以管理学生信息的改查功能等</pre>
			</div>
		</div>
	</div>
