	...
	<div class="am-cf admin-main">
		...
		<div class="admin">
			...
			<div class="admin-biaoge">
				<div class="xinxitj">教师信息修改</div>
				<form action="adminupdate" method="post">
				<% List list=(List)session.getAttribute("allinfo");
					AdminPO admin=(AdminPO)list.get(0);
				%>
				<table class="am-table">
						<tr>
							<th>教师姓名:</th>
							<td><input type="text" name="name" style="width: 400px;float: left;" value="<%=admin.getName()%>"></td>
						</tr>
						<tr>
							<th>教师密码:</th>
							<td><input type="text" name="password" style="width: 400px;float: left;" value="<%=admin.getPassword()%>"></td>
						</tr>
						<tr>
