		...
		<div class="admin">
			...
			<div class="admin-biaoge">
				...
				<table class="am-table">
						...
						<tr>
							<th>教师密码:</th>
							<td><input type="password" name="password" style="width: 400px;float: left;"></td>
						</tr>
						<tr>
							<th>确认密码:</th>
							<td><input type="password" name="passwordcheck" style="width: 400px;float: left;"></td>
						</tr>
						<tr>
