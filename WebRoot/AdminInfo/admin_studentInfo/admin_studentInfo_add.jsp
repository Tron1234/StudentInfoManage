	...
	<div class="am-cf admin-main">
		...
		<div class="admin">
			...
			<div class="admin-biaoge">
				<div class="xinxitj">学生信息添加</div>
				<form action="studentadd" method="post">
				<table class="am-table">
						<tr>
							<th>学生学号:</th>
							<td><input type="text" name="number" style="width: 400px;float: left;"></td>
						</tr>
						<tr>
							<th>学生姓名:</th>
							<td><input type="text" name="name" style="width: 400px;float: left;"></td>
						</tr>
						<tr>
							<th>学生密码:</th>
							<td><input type="text" name="password" style="width: 400px;float: left;"></td>
						</tr>
						<tr>
							<th>学生年龄:</th>
							<td><input type="number" name="age" style="width: 400px;float: left;"></td>
						</tr>
						<tr>
							<th>学生性别:</th>
							<td><input type="text" name="sex" style="width: 400px;float: left;"></td>
						</tr>
						<tr>
							<th>学生电话:</th>
							<td><input type="text" name="phone" style="width: 400px;float: left;"></td>
						</tr>
						<tr>
							<th>学生部门:</th>
							<td><select name="department" style="width: 400px;margin-bottom: 10px;float: left">
				<%
    		List list=(List)session.getAttribute("allinfo1");
    		if(list==null){
    	 %>
    	 	<option value="">无部门信息</option>
    	 <%}else{
    		for(int i=0;i<list.size();i++){
    			DepartmentPO department=(DepartmentPO)list.get(i);
    	 %>
				...
				<%}
						...
						<tr>
						<td><input type="submit" value="添加" style="width: 80px"></td>
