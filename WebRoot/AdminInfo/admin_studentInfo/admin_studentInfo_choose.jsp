	...
	<div class="am-cf admin-main">
		...
		<div class="admin">
			...
			<div class="admin-biaoge">
				<div class="xinxitj">学生学号选择</div>
				<form action="studentupdatecheck" method="post">
				<select name="select" style="width: 100px;margin-bottom: 10px">
				<%
    		List list=(List)session.getAttribute("allinfo");
    		if(list==null){
    	 %>
    	 	<option value="">无学生学号</option>
    	 <%}else{
    		for(int i=0;i<list.size();i++){
    			StudentPO student=(StudentPO)list.get(i);
    	 %>
				<option value="<%=student.getNumber()%>" ><%=student.getNumber()%></option>
				<%}
    	} %>	
				</select>
				<br/>
