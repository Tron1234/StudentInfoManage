	...
	<div class="am-cf admin-main">
		...
		<div class="admin">
			...
			<div class="admin-biaoge">
				<div class="xinxitj">部门信息添加</div>
				<form action="departmentadd" method="post">
				<table class="am-table">
					<tr>
							<th>部门编号:</th>
							<td><input type="text" name="id" style="width: 300px;float: left;"></td>
						</tr>
						<tr>
							<th>部门名称:</th>
							<td><input type="text" name="name" style="width: 300px;float: left;"></td>
						</tr>
						<tr>
							<th>部门类别:</th>
							<td><input type="text" name="type" style="width: 300px;float: left;"></td>
						</tr>
						<tr>
