	...
	<div class="am-cf admin-main">
		...
		<div class="admin">
			...
			<div class="admin-biaoge">
				<div class="xinxitj">部门信息修改</div>
				<form action="departmentupdate" method="post">
				<% List list=(List)session.getAttribute("allinfo");
					DepartmentPO department=(DepartmentPO)list.get(0);
				%>
				<table class="am-table">
						<tr>
							<th>部门名称:</th>
							<td><input type="text" name="name" style="width: 300px;float: left;" value="<%=department.getName()%>"></td>
						</tr>
						<tr>
							<th>部门类别:</th>
							<td><input type="text" name="type" style="width: 300px;float: left;" value="<%=department.getType()%>"></td>
						</tr>
						<tr>
